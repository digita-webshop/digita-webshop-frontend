...
import ContentHeader from "components/PanelProducts/ContentHeader/ContentHeader";
import PanelPagination from "components/Pagination/PanelPagination";
import { DashWrapper, paginationStyle } from "components/PanelProducts/styles";
import Article from "components/PanelArticle/PanelArticle";
import { ArticleWrapper } from "components/PanelArticle/styles";
import { useDeleteArticleMutation, useGetAllArticlesQuery } from "redux/articles/articlesApi";
import NotFound from "components/EmptyList/NotFound";
import { errorMessage, successMessage } from "utils/toastMessages";
import { ErrorText } from "styles/panel";
import PanelLoading from "components/Loading/PanelLoading";
import { GridHeader } from "components/PanelProducts";
      ...
      <Grid item xs={12}>
        ...
        <ArticleWrapper sx={{ position: "relative" }}>
          <Grid container spacing={2}>
            ...
            {articles?.length !== 0 &&
              articles.map(({ _id, title, image, writer, createdAt, category }) => (
