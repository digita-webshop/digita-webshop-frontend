      ...
      <Box sx={{ position: "relative" }}>
        <UserNavItem>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            <Box sx={userAvatarStyle} id="user-button" onClick={() => navigate("/user/personal-info")}>
              <img
            ...
            <Typography sx={{ fontWeight: "bold" }}>Siavash Khani</Typography>
          </Box>
          <EditIcon sx={{ color: "common.digitaRed", cursor: "pointer" }}  onClick={() => navigate("/user/personal-info")}/>
        </UserNavItem>
        ...
        <UserNavItem>
          ...
          <Typography sx={{ fontWeight: "bold", color: "#333" }}>813 $</Typography>
        </UserNavItem>
        ...
        <UserNavItem> 
          ...
          <Typography sx={{ fontWeight: "bold", color: "#333" }}>130</Typography>
        </UserNavItem>
      </Box>
    </>
  );
