      ...
      <Grid item xs={12} sm={6} lg={3}>
        ...
        <Box sx={itemStyle}>
          ...
          <Box sx={{ marginLeft: "0.6rem" }}>
            ...
            <Typography sx={{ fontWeight: 500, color: "#777" }}>For all order over $99</Typography>
          </Box>
        </Box>
      </Grid>
      ...
      <Grid item xs={12} sm={6} lg={3}>
        <Box sx={itemStyle}>
          ...
          <Box sx={{ marginLeft: "0.6rem" }}>
            ...
            <Typography sx={{ fontWeight: 500, color: "#777" }}>If good have problems</Typography>
          </Box>
        </Box>
      </Grid>
      ...
      <Grid item xs={12} sm={6} lg={3}>
        <Box sx={itemStyle}>
          ...
          <Box sx={{ marginLeft: "0.6rem" }}>
            ...
            <Typography sx={{ fontWeight: 500, color: "#777" }}>100% secure payment</Typography>
          </Box>
        </Box>
      </Grid>
      ...
      <Grid item xs={12} sm={6} lg={3}>
        <Box sx={itemStyle}>
          ...
          <Box sx={{ marginLeft: "0.6rem" }}>
            ...
            <Typography sx={{ fontWeight: 500, color: "#777" }}>Always ready to help</Typography>
          </Box>
        </Box>
      </Grid>
    </Grid>
